 ...
 *     containing the pattern. NOT yet fixed, flagged as a follow-up:
 *     moveHolon()'s reparenting and promoteEntity()'s containment link
 *     (holon:isPartOf on the realised child) still push to graphIri: null
 *     and are subject to the identical invisibility problem for
 *     resolveCapabilities()'s ancestor-walk parentQuery, which also wraps
 *     in GRAPH ?registryGraph.
